...
FIND_LIBRARY(AMD_LIBRARY NAMES amd ${AMD_NAMES} PATHS ${AMD_LIBRARIES})
...
FIND_LIBRARY(CAMD_LIBRARY NAMES camd ${CAMD_NAMES} PATHS ${CAMD_LIBRARIES})
...
FIND_LIBRARY(COLAMD_LIBRARY NAMES colamd ${COLAMD_NAMES} PATHS ${COLAMD_LIBRARIES})
...
FIND_LIBRARY(CCOLAMD_LIBRARY NAMES ccolamd ${CCOLAMD_NAMES} PATHS ${CCOLAMD_LIBRARIES})
...
FIND_LIBRARY(CHOLMOD_LIBRARY NAMES cholmod ${CHOLMOD_NAMES} PATHS ${CHOLMOD_LIBRARIES})
...
FIND_LIBRARY(UMFPACK_LIBRARY NAMES umfpack ${UMFPACK_NAMES} PATHS ${UMFPACK_LIBRARIES})
...
FIND_LIBRARY(SUITESPARSE_CONFIG_LIBRARY NAMES suitesparseconfig ${SUITESPARSE_CONFIG_NAMES} PATHS ${SUITESPARSE_CONFIG_LIBRARIES})
