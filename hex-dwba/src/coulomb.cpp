...
Coulomb_wave_functions::Coulomb_wave_functions (bool is_it_normalized_c, Complex const & l_c, Complex const & eta_c)
  : l (l_c),
    ...
    is_H_dir_int_naive (false),cwf_real_ptr (nullptr),cwf_real_eta_plus_ptr (nullptr),cwf_real_eta_minus_ptr (nullptr),cwf_real_l_plus_ptr (nullptr),cwf_real_l_minus_ptr (nullptr),
    cwf_minus_eta_ptr (nullptr),cwf_lp_ptr (nullptr),prec_first_order_expansion (0.1*sqrt_precision),noclean(false),owner(true)
{
...
Coulomb_wave_functions::Coulomb_wave_functions(Coulomb_wave_functions const & WW)
  : l (WW.l),
    eta (WW.eta), 
    is_it_normalized (WW.is_it_normalized),
    neg_int_omega_one (WW.neg_int_omega_one),
    neg_int_omega_minus_one (WW.neg_int_omega_minus_one),
    sigma_l (WW.sigma_l),
    log_Cl_eta (WW.log_Cl_eta),
    Cl_eta (WW.Cl_eta),
    exp_I_chi (WW.exp_I_chi),
    exp_minus_I_chi (WW.exp_minus_I_chi),
    one_over_sin_chi (WW.one_over_sin_chi),
    log_cut_constant_CFa_plus (WW.log_cut_constant_CFa_plus),
    log_cut_constant_CFa_minus (WW.log_cut_constant_CFa_minus),
    cut_constant_CFa_plus (WW.cut_constant_CFa_plus),
    cut_constant_CFa_minus (WW.cut_constant_CFa_plus),
    log_cut_constant_CFb_plus (WW.log_cut_constant_CFb_plus),
    log_cut_constant_CFb_minus (WW.log_cut_constant_CFb_minus),
    log_cut_constant_AS_plus (WW.log_cut_constant_AS_plus),
    log_cut_constant_AS_minus (WW.log_cut_constant_AS_minus),
    cut_constant_CFb_plus (WW.cut_constant_CFb_plus),
    cut_constant_CFb_minus (WW.cut_constant_CFb_minus),
    log_sym_constant_arg_neg (WW.log_sym_constant_arg_neg),
    log_sym_constant_arg_pos (WW.log_sym_constant_arg_pos),
    sym_constant_arg_neg (WW.sym_constant_arg_neg),
    sym_constant_arg_pos (WW.sym_constant_arg_pos), 
    turning_point (WW.turning_point),
    is_H_dir_int_naive (WW.is_H_dir_int_naive),cwf_real_ptr (WW.cwf_real_ptr),cwf_real_eta_plus_ptr (WW.cwf_real_eta_plus_ptr),
    cwf_real_eta_minus_ptr (WW.cwf_real_eta_minus_ptr),cwf_real_l_plus_ptr (WW.cwf_real_l_plus_ptr ),
    cwf_real_l_minus_ptr (WW.cwf_real_l_minus_ptr ),cwf_minus_eta_ptr (WW.cwf_minus_eta_ptr),
    cwf_lp_ptr (WW.cwf_lp_ptr),prec_first_order_expansion (WW.prec_first_order_expansion ),
    noclean(WW.noclean),owner(false)
{
}
