...
/**
 * Class members compute contributions to the first order of the distorted
...
public:
	 ...
	 */
	static Complex computeDirect1e(
	 ...
	 */
	static Complex computeDirect2e(
	 ...
	 * \param li Initial projectile partial wave.
	 */
	static Complex computeExchange2e(
		const DistortingPotential& U, int lambda,
		int Nf, int Lf, double kf, int lf,
		int Ni, int Li, double ki, int li
	);
