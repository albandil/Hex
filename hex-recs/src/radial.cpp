...
void RadialIntegrals::setupOneElectronIntegrals ()
{
    ...
    char D_name[20], S_name[20], Mm1_name[20], Mm1_tr_name[20], Mm2_name[20], Mm3_tr_name[20];
    ...
    std::snprintf (Mm3_tr_name, sizeof(Mm3_tr_name), "%d-Mm3_tr.hdf", bspline_.order());
    ...
    Mm3_tr_.hdfload(Mm3_tr_name) or Mm3_tr_.populate (
        bspline_.order(),    [=](int m, int n) -> Complex { return computeM(-3, m, n, bspline_.Nreknot() - 1);}
    ).hdfsave(Mm3_tr_name);
    std::cout << "ok\n\n";
}
